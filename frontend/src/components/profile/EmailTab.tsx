    ...
    <div className="space-y-8 animate-in fade-in duration-300 font-sans">
      ...
      <div className="sahara-card bg-[var(--color-surface)] rounded-2xl border border-[var(--color-outline-variant)] p-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
        ...
        <div className="flex items-center gap-4">
          {user?.email_verified ? (
            <div className="w-12 h-12 bg-[#10B981]/20 rounded-xl flex items-center justify-center border border-[#10B981]/50 text-[#10B981]">
              <ShieldCheck size={24} />
            </div>
          ) : (
            <div className="w-12 h-12 bg-[#F59E0B]/20 rounded-xl flex items-center justify-center border border-[#F59E0B]/50 text-[#F59E0B]">
              <AlertCircle size={24} />
            </div>
          )}
