...
"""),
    ...
    with open(
        os.path.join(NOTEBOOK_DIR, "K_Mastery_OCR_Training.ipynb"),
        "w",
        encoding="utf-8",
    ) as f:
        nbf.write(nb, f)
...
"""),
    ...
    with open(
        os.path.join(NOTEBOOK_DIR, "K_Mastery_Audio_Fluency_Training.ipynb"),
        "w",
        encoding="utf-8",
    ) as f:
        nbf.write(nb, f)
