...
def generate_hf_vocab(db: Session):
    ...
    try:
        ds = load_dataset("jaylee8864/korean-vocabulary-5000",
                          "en", split="train")
    ...
    db.commit()
    print(
        f"Injection Complete! Successfully added {count} NEW words. (Skipped {duplicate_count} duplicates)."
    )
