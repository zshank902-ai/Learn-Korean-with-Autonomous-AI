...
FALLBACK_VOCAB = [
    ...
    {"word": "약속", "meaning": "Appointment",
        "pronunciation": "yak-sok", "level": 2},
    {
        "word": "도착하다",
        "meaning": "To arrive",
        "pronunciation": "do-chak-ha-da",
        "level": 2,
    },
    {
        "word": "출발하다",
    ...
    # TOPIK 3
    {
        "word": "결정하다",
        "meaning": "To decide",
        "pronunciation": "gyeol-jeong-ha-da",
        "level": 3,
    },
    {
        "word": "해결하다",
    ...
    {
        "word": "관련되다",
        "meaning": "To be related",
        "pronunciation": "gwan-ryeon-doe-da",
        "level": 4,
    },
    {
        "word": "예상하다",
    ...
    },
    {
        ...
        "pronunciation": "hyo-gwa-jeog-i-da",
        "level": 4,
    },
    {
        "word": "다양하다",
        "meaning": "To be diverse",
        "pronunciation": "da-yang-ha-da",
        "level": 4,
    },
    {
        "word": "구체적이다",
        "meaning": "To be concrete",
        "pronunciation": "gu-che-jeog-i-da",
        "level": 4,
    },
    # TOPIK 5
    ...
    # TOPIK 6
    {"word": "모순", "meaning": "Contradiction",
        "pronunciation": "mo-sun", "level": 6},
    {"word": "철학", "meaning": "Philosophy",
        "pronunciation": "cheol-hak", "level": 6},
    ...
    {"word": "본질", "meaning": "Essence", "pronunciation": "bon-jil", "level": 6},
    {
        ...
        "pronunciation": "chu-sang-jeog-i-da",
        "level": 6,
    },
    {
        "word": "지배하다",
...
def generate_vocab(db: Session):
    ...
    for i in range(1, 7):
        ...
        if not lvl:
            lvl = TopikLevel(
                level_num=i,
                title=f"TOPIK {i}",
                description=f"Mastery for TOPIK Level {i}",
            )
            db.add(lvl)
            db.commit()
            db.refresh(lvl)
    ...
    for item in FALLBACK_VOCAB:
        existing = db.query(VocabItem).filter(
            VocabItem.word == item["word"]).first()
        if not existing:
            vocab = VocabItem(
                word=item["word"],
                meaning=item["meaning"],
                pronunciation=item["pronunciation"],
                level_id=levels[int(str(item["level"]))],
            )
            db.add(vocab)
