...
async def send_verification_email(to_email: str, token: str, frontend_url: str = "http://localhost:3000"):
    """
    ...
    if not resend.api_key:
        ...
        print(f"MOCK EMAIL: Would have sent verification link to {to_email}: {frontend_url}/verify-email?token={token}")
        return True
