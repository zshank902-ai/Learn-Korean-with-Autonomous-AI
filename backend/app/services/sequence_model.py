...
class KoreanSequenceModel:
    ...
    def _build_hybrid_architecture(self):
        ...
        model = keras.Sequential([
            # 1. Embedding Layer
            layers.Embedding(input_dim=self.vocab_size, output_dim=128, input_length=self.max_length),
            ...
            layers.Dropout(0.3),
            layers.Dense(1, activation='sigmoid') # Probability of "Grammatically Correct"
        ])
